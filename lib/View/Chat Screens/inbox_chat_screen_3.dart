...
class InboxChatScreen3 extends StatefulWidget {
  const InboxChatScreen3({super.key});

  @override
  State<InboxChatScreen3> createState() => _InboxChatScreen3State();
}

class _InboxChatScreen3State extends State<InboxChatScreen3> {
  @override
                  ...
                  child: const Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Great! I’ll send over offer right ",
                          style:
